...
# echo "--volume=\'SOME_PATH/geant4-data:/opt/geant4/data:ro\' "
...
# echo "--volume=\'SOME_PATH/geant4-data:/opt/geant4/data\' "
# echo "#############################################################################################"
# echo " "
# echo "## Geant4 examples ##########################################################################"
# echo "To save space, Geant4 examples have been removed, to download them:"
# echo "wget https://gitlab.cern.ch/geant4/geant4/-/archive/geant4-`geant4-config --version | awk -F '.' '{print $1"."$2}'`-release/geant4-master.tar.gz?path=examples -O examples.tar.gz && tar xf examples.tar.gz --strip-components 1"
# echo " "
